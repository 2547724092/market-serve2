...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/system?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=GMT%2B8");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("root");  //如果你的密码不是root，改成自己密码
...
//      pc.setModuleName(scanner("模块名"));
        ...
        pc.setEntity("entity");   //生成实体类存入到 com.wanli.entity
